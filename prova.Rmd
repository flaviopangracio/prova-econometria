...
## Transformação e junção dos dados
...
## Criação de duumies e filtragem da amostra
...
print(1/(1 + exp(-(reglogit$coefficients[1] + reglogit$coefficients[2]*1000)))) # 0.7428796

## Probabilidade de um indivíduo possuir uma casa, com renda mensal per capita de 3000
print(1/(1 + exp(-(reglogit$coefficients[1] + reglogit$coefficients[2]*3000)))) # 0.7657695

## Probabilidade de um indivíduo possuir uma casa, com renda mensal per capita de 5000
print(1/(1 + exp(-(reglogit$coefficients[1] + reglogit$coefficients[2]*5000)))) # 0.7872053
```
## Efeitos marginais
```{r}
## Efeitos marginais
logitescalar <-(mean(dlogis(predict(reglogit,type='link'))))
print(logitescalar * coef(reglogit))
